...
import (
	actioncache "github.com/chagui/besreceiver/internal/bep/actioncache"
	analysiscache "github.com/chagui/besreceiver/internal/bep/analysiscache"
	commandline "github.com/chagui/besreceiver/internal/bep/commandline"
	failuredetails "github.com/chagui/besreceiver/internal/bep/failuredetails"
	invocationpolicy "github.com/chagui/besreceiver/internal/bep/invocationpolicy"
	packagemetrics "github.com/chagui/besreceiver/internal/bep/packagemetrics"
...
func (BuildEventId_FetchId_Downloader) EnumDescriptor() ([]byte, []int) {
	return file_build_event_stream_proto_rawDescGZIP(), []int{0, 7, 0}
}
...
func (ConvenienceSymlink_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_build_event_stream_proto_enumTypes[5].Descriptor()
}

func (ConvenienceSymlink_Action) Type() protoreflect.EnumType {
	return &file_build_event_stream_proto_enumTypes[5]
}
...
type BuildStarted struct {
	...
	JavaVersionInfo *JavaVersionInfo `protobuf:"bytes,12,opt,name=java_version_info,json=javaVersionInfo,proto3" json:"java_version_info,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *BuildStarted) GetJavaVersionInfo() *JavaVersionInfo {
	if x != nil {
		return x.JavaVersionInfo
	}
	return nil
}
...
type OptionsParsed struct {
	...
	InvocationPolicy       *invocationpolicy.InvocationPolicy `protobuf:"bytes,5,opt,name=invocation_policy,json=invocationPolicy,proto3" json:"invocation_policy,omitempty"`
...
func (x *OptionsParsed) GetInvocationPolicy() *invocationpolicy.InvocationPolicy {
	if x != nil {
...
type ActionExecuted struct {
	...
	FailureDetail *failuredetails.FailureDetail `protobuf:"bytes,11,opt,name=failure_detail,json=failureDetail,proto3" json:"failure_detail,omitempty"`
...
func (x *ActionExecuted) GetFailureDetail() *failuredetails.FailureDetail {
	if x != nil {
...
type TargetComplete struct {
	...
	FailureDetail *failuredetails.FailureDetail `protobuf:"bytes,9,opt,name=failure_detail,json=failureDetail,proto3" json:"failure_detail,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TargetComplete) GetFailureDetail() *failuredetails.FailureDetail {
	if x != nil {
		return x.FailureDetail
	}
	return nil
...
type BuildFinished struct {
	...
	// Only populated if success = false, and sometimes not even then.
	FailureDetail *failuredetails.FailureDetail `protobuf:"bytes,6,opt,name=failure_detail,json=failureDetail,proto3" json:"failure_detail,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BuildFinished) GetFailureDetail() *failuredetails.FailureDetail {
	if x != nil {
		return x.FailureDetail
	}
	return nil
...
type JavaVersionInfo struct {
	...
	JavaMajorVersion int32 `protobuf:"varint,2,opt,name=java_major_version,json=javaMajorVersion,proto3" json:"java_major_version,omitempty"`
	// The minor Java version, e.g. 0.
	JavaMinorVersion int32 `protobuf:"varint,3,opt,name=java_minor_version,json=javaMinorVersion,proto3" json:"java_minor_version,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *JavaVersionInfo) Reset() {
	*x = JavaVersionInfo{}
...
func (x *JavaVersionInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JavaVersionInfo) ProtoMessage() {}

func (x *JavaVersionInfo) ProtoReflect() protoreflect.Message {
	mi := &file_build_event_stream_proto_msgTypes[29]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JavaVersionInfo.ProtoReflect.Descriptor instead.
func (*JavaVersionInfo) Descriptor() ([]byte, []int) {
	return file_build_event_stream_proto_rawDescGZIP(), []int{29}
}

func (x *JavaVersionInfo) GetJavaVersion() string {
	if x != nil {
...
func (x *JavaVersionInfo) GetJavaMajorVersion() int32 {
	if x != nil {
		return x.JavaMajorVersion
	}
	return 0
}

func (x *JavaVersionInfo) GetJavaMinorVersion() int32 {
	if x != nil {
		return x.JavaMinorVersion
	}
	return 0
}
...
func (*BuildEvent) Descriptor() ([]byte, []int) {
	return file_build_event_stream_proto_rawDescGZIP(), []int{30}
}
...
func (x *BuildEvent) GetStructuredCommandLine() *commandline.CommandLine {
	if x != nil {
...
type BuildEvent_StructuredCommandLine struct {
	StructuredCommandLine *commandline.CommandLine `protobuf:"bytes,22,opt,name=structured_command_line,json=structuredCommandLine,proto3,oneof"`
}
...
type BuildMetrics_ActionSummary struct {
	...
	ActionCacheStatistics *actioncache.ActionCacheStatistics        `protobuf:"bytes,7,opt,name=action_cache_statistics,json=actionCacheStatistics,proto3" json:"action_cache_statistics,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *BuildMetrics_ActionSummary) GetActionCacheStatistics() *actioncache.ActionCacheStatistics {
	if x != nil {
...
type BuildMetrics_PackageMetrics struct {
	...
	PackageLoadMetrics []*packagemetrics.PackageLoadMetrics `protobuf:"bytes,2,rep,name=package_load_metrics,json=packageLoadMetrics,proto3" json:"package_load_metrics,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *BuildMetrics_PackageMetrics) GetPackageLoadMetrics() []*packagemetrics.PackageLoadMetrics {
	if x != nil {
...
type BuildMetrics_WorkerMetrics struct {
	...
	Code                 *failuredetails.Worker_Code             `protobuf:"varint,12,opt,name=code,proto3,enum=failure_details.Worker_Code,oneof" json:"code,omitempty"`
...
func (x *BuildMetrics_WorkerMetrics) GetCode() failuredetails.Worker_Code {
	if x != nil && x.Code != nil {
		return *x.Code
	}
	return failuredetails.Worker_Code(0)
}
...
// buckets, but if need be, we could add things like stddev or percentiles.
type BuildMetrics_Distribution struct {
	state           protoimpl.MessageState                       `protogen:"open.v1"`
	HistogramBucket []*BuildMetrics_Distribution_HistogramBucket `protobuf:"bytes,1,rep,name=histogram_bucket,json=histogramBucket,proto3" json:"histogram_bucket,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *BuildMetrics_Distribution) Reset() {
	*x = BuildMetrics_Distribution{}
	mi := &file_build_event_stream_proto_msgTypes[80]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BuildMetrics_Distribution) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuildMetrics_Distribution) ProtoMessage() {}

func (x *BuildMetrics_Distribution) ProtoReflect() protoreflect.Message {
	mi := &file_build_event_stream_proto_msgTypes[80]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuildMetrics_Distribution.ProtoReflect.Descriptor instead.
func (*BuildMetrics_Distribution) Descriptor() ([]byte, []int) {
	return file_build_event_stream_proto_rawDescGZIP(), []int{23, 13}
}

func (x *BuildMetrics_Distribution) GetHistogramBucket() []*BuildMetrics_Distribution_HistogramBucket {
	if x != nil {
...
type BuildMetrics_RemoteAnalysisCacheStatistics struct {
	...
	ValueStoreReadLatencyMicros         *BuildMetrics_Distribution `protobuf:"bytes,17,opt,name=value_store_read_latency_micros,json=valueStoreReadLatencyMicros,proto3" json:"value_store_read_latency_micros,omitempty"`
	ValueStoreReadBatchLatencyMicros    *BuildMetrics_Distribution `protobuf:"bytes,18,opt,name=value_store_read_batch_latency_micros,json=valueStoreReadBatchLatencyMicros,proto3" json:"value_store_read_batch_latency_micros,omitempty"`
	ValueStoreWriteLatencyMicros        *BuildMetrics_Distribution `protobuf:"bytes,19,opt,name=value_store_write_latency_micros,json=valueStoreWriteLatencyMicros,proto3" json:"value_store_write_latency_micros,omitempty"`
	ValueStoreWriteBatchLatencyMicros   *BuildMetrics_Distribution `protobuf:"bytes,20,opt,name=value_store_write_batch_latency_micros,json=valueStoreWriteBatchLatencyMicros,proto3" json:"value_store_write_batch_latency_micros,omitempty"`
	AnalysisCacheReadLatencyMicros      *BuildMetrics_Distribution `protobuf:"bytes,21,opt,name=analysis_cache_read_latency_micros,json=analysisCacheReadLatencyMicros,proto3" json:"analysis_cache_read_latency_micros,omitempty"`
	AnalysisCacheReadBatchLatencyMicros *BuildMetrics_Distribution `protobuf:"bytes,22,opt,name=analysis_cache_read_batch_latency_micros,json=analysisCacheReadBatchLatencyMicros,proto3" json:"analysis_cache_read_batch_latency_micros,omitempty"`
	// The result of the Skycache metadata lookup.
	MetadataLookupResult analysiscache.TopLevelTargetsMatchStatus `protobuf:"varint,16,opt,name=metadata_lookup_result,json=metadataLookupResult,proto3,enum=devtools_blaze_proto.TopLevelTargetsMatchStatus" json:"metadata_lookup_result,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (*BuildMetrics_RemoteAnalysisCacheStatistics) Descriptor() ([]byte, []int) {
	return file_build_event_stream_proto_rawDescGZIP(), []int{23, 14}
}
...
func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreReadLatencyMicros() *BuildMetrics_Distribution {
	if x != nil {
		return x.ValueStoreReadLatencyMicros
	}
	return nil
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreReadBatchLatencyMicros() *BuildMetrics_Distribution {
	if x != nil {
		return x.ValueStoreReadBatchLatencyMicros
	}
	return nil
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreWriteLatencyMicros() *BuildMetrics_Distribution {
	if x != nil {
		return x.ValueStoreWriteLatencyMicros
	}
	return nil
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetValueStoreWriteBatchLatencyMicros() *BuildMetrics_Distribution {
	if x != nil {
		return x.ValueStoreWriteBatchLatencyMicros
	}
	return nil
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetAnalysisCacheReadLatencyMicros() *BuildMetrics_Distribution {
	if x != nil {
		return x.AnalysisCacheReadLatencyMicros
	}
	return nil
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetAnalysisCacheReadBatchLatencyMicros() *BuildMetrics_Distribution {
	if x != nil {
		return x.AnalysisCacheReadBatchLatencyMicros
	}
	return nil
}

func (x *BuildMetrics_RemoteAnalysisCacheStatistics) GetMetadataLookupResult() analysiscache.TopLevelTargetsMatchStatus {
	if x != nil {
		return x.MetadataLookupResult
	}
	return analysiscache.TopLevelTargetsMatchStatus(0)
}
...
func (x *BuildMetrics_NetworkMetrics_SystemNetworkStats) Reset() {
	*x = BuildMetrics_NetworkMetrics_SystemNetworkStats{}
	mi := &file_build_event_stream_proto_msgTypes[89]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *BuildMetrics_WorkerPoolMetrics_WorkerPoolStats) Reset() {
	*x = BuildMetrics_WorkerPoolMetrics_WorkerPoolStats{}
	mi := &file_build_event_stream_proto_msgTypes[90]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *BuildMetrics_DynamicExecutionMetrics_RaceStatistics) Reset() {
	*x = BuildMetrics_DynamicExecutionMetrics_RaceStatistics{}
	mi := &file_build_event_stream_proto_msgTypes[91]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type BuildMetrics_Distribution_HistogramBucket struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Min           int64                  `protobuf:"varint,1,opt,name=min,proto3" json:"min,omitempty"`     // inclusive
	Max           int64                  `protobuf:"varint,2,opt,name=max,proto3" json:"max,omitempty"`     // exclusive
	Count         int64                  `protobuf:"varint,3,opt,name=count,proto3" json:"count,omitempty"` // number of values in the bucket
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BuildMetrics_Distribution_HistogramBucket) Reset() {
	*x = BuildMetrics_Distribution_HistogramBucket{}
	mi := &file_build_event_stream_proto_msgTypes[92]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BuildMetrics_Distribution_HistogramBucket) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BuildMetrics_Distribution_HistogramBucket) ProtoMessage() {}

func (x *BuildMetrics_Distribution_HistogramBucket) ProtoReflect() protoreflect.Message {
	mi := &file_build_event_stream_proto_msgTypes[92]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BuildMetrics_Distribution_HistogramBucket.ProtoReflect.Descriptor instead.
func (*BuildMetrics_Distribution_HistogramBucket) Descriptor() ([]byte, []int) {
	return file_build_event_stream_proto_rawDescGZIP(), []int{23, 13, 0}
}

func (x *BuildMetrics_Distribution_HistogramBucket) GetMin() int64 {
	if x != nil {
		return x.Min
	}
	return 0
...
func (x *BuildMetrics_Distribution_HistogramBucket) GetMax() int64 {
	if x != nil {
		return x.Max
	}
	return 0
...
func (x *BuildMetrics_Distribution_HistogramBucket) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
const file_build_event_stream_proto_rawDesc = "" +
	"\n" +
	"\x18build_event_stream.proto\x12\x12build_event_stream\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1apackage_load_metrics.proto\x1a,analysis_cache_service_metadata_status.proto\x1a\x12action_cache.proto\x1a\x12command_line.proto\x1a\x15failure_details.proto\x1a\x17invocation_policy.proto\"\xc6#\n" +
	"\fBuildEventId\x12P\n" +
	...
	"\x04user\x18\v \x01(\tR\x04user\x12O\n" +
	"\x11java_version_info\x18\f \x01(\v2#.build_event_stream.JavaVersionInfoR\x0fjavaVersionInfo\"9\n" +
	...
	"\rAnomalyReport\x12#\n" +
	"\rwas_suspended\x18\x01 \x01(\bR\fwasSuspended\"\x92N\n" +
	"\fBuildMetrics\x12U\n" +
	...
	"remoteWins\x1a\xc5\x01\n" +
	"\fDistribution\x12h\n" +
	"\x10histogram_bucket\x18\x01 \x03(\v2=.build_event_stream.BuildMetrics.Distribution.HistogramBucketR\x0fhistogramBucket\x1aK\n" +
	"\x0fHistogramBucket\x12\x10\n" +
	"\x03min\x18\x01 \x01(\x03R\x03min\x12\x10\n" +
	"\x03max\x18\x02 \x01(\x03R\x03max\x12\x14\n" +
	"\x05count\x18\x03 \x01(\x03R\x05count\x1a\x97\r\n" +
	...
	"\x16analysis_cache_batches\x18\x0f \x01(\x03R\x14analysisCacheBatches\x12s\n" +
	"\x1fvalue_store_read_latency_micros\x18\x11 \x01(\v2-.build_event_stream.BuildMetrics.DistributionR\x1bvalueStoreReadLatencyMicros\x12~\n" +
	"%value_store_read_batch_latency_micros\x18\x12 \x01(\v2-.build_event_stream.BuildMetrics.DistributionR valueStoreReadBatchLatencyMicros\x12u\n" +
	" value_store_write_latency_micros\x18\x13 \x01(\v2-.build_event_stream.BuildMetrics.DistributionR\x1cvalueStoreWriteLatencyMicros\x12\x80\x01\n" +
	"&value_store_write_batch_latency_micros\x18\x14 \x01(\v2-.build_event_stream.BuildMetrics.DistributionR!valueStoreWriteBatchLatencyMicros\x12y\n" +
	"\"analysis_cache_read_latency_micros\x18\x15 \x01(\v2-.build_event_stream.BuildMetrics.DistributionR\x1eanalysisCacheReadLatencyMicros\x12\x84\x01\n" +
	"(analysis_cache_read_batch_latency_micros\x18\x16 \x01(\v2-.build_event_stream.BuildMetrics.DistributionR#analysisCacheReadBatchLatencyMicros\x12f\n" +
	"\x16metadata_lookup_result\x18\x10 \x01(\x0e20.devtools_blaze_proto.TopLevelTargetsMatchStatusR\x14metadataLookupResult\";\n" +
	"\rBuildToolLogs\x12*\n" +
	...
	"\x0fJavaVersionInfo\x12!\n" +
	"\fjava_version\x18\x01 \x01(\tR\vjavaVersion\x12,\n" +
	"\x12java_major_version\x18\x02 \x01(\x05R\x10javaMajorVersion\x12,\n" +
	"\x12java_minor_version\x18\x03 \x01(\x05R\x10javaMinorVersion\"\x83\x10\n" +
	"\n" +
	"BuildEvent\x120\n" +
	...
	"\x1aTOOL_HALTED_BEFORE_TESTING\x10\bB=Z;github.com/chagui/besreceiver/internal/bep/buildeventstreamb\x06proto3"

var (
	file_build_event_stream_proto_rawDescOnce sync.Once
	file_build_event_stream_proto_rawDescData []byte
)

func file_build_event_stream_proto_rawDescGZIP() []byte {
	file_build_event_stream_proto_rawDescOnce.Do(func() {
		file_build_event_stream_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_build_event_stream_proto_rawDesc), len(file_build_event_stream_proto_rawDesc)))
	})
	return file_build_event_stream_proto_rawDescData
}

var file_build_event_stream_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_build_event_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 93)
var file_build_event_stream_proto_goTypes = []any{
	...
	(*JavaVersionInfo)(nil),                                     // 35: build_event_stream.JavaVersionInfo
	(*BuildEvent)(nil),                                          // 36: build_event_stream.BuildEvent
	(*BuildEventId_UnknownBuildEventId)(nil),                    // 37: build_event_stream.BuildEventId.UnknownBuildEventId
	(*BuildEventId_ProgressId)(nil),                             // 38: build_event_stream.BuildEventId.ProgressId
	(*BuildEventId_BuildStartedId)(nil),                         // 39: build_event_stream.BuildEventId.BuildStartedId
	(*BuildEventId_UnstructuredCommandLineId)(nil),              // 40: build_event_stream.BuildEventId.UnstructuredCommandLineId
	(*BuildEventId_StructuredCommandLineId)(nil),                // 41: build_event_stream.BuildEventId.StructuredCommandLineId
	(*BuildEventId_WorkspaceStatusId)(nil),                      // 42: build_event_stream.BuildEventId.WorkspaceStatusId
	(*BuildEventId_OptionsParsedId)(nil),                        // 43: build_event_stream.BuildEventId.OptionsParsedId
	(*BuildEventId_FetchId)(nil),                                // 44: build_event_stream.BuildEventId.FetchId
	(*BuildEventId_PatternExpandedId)(nil),                      // 45: build_event_stream.BuildEventId.PatternExpandedId
	(*BuildEventId_WorkspaceConfigId)(nil),                      // 46: build_event_stream.BuildEventId.WorkspaceConfigId
	(*BuildEventId_BuildMetadataId)(nil),                        // 47: build_event_stream.BuildEventId.BuildMetadataId
	(*BuildEventId_TargetConfiguredId)(nil),                     // 48: build_event_stream.BuildEventId.TargetConfiguredId
	(*BuildEventId_NamedSetOfFilesId)(nil),                      // 49: build_event_stream.BuildEventId.NamedSetOfFilesId
	(*BuildEventId_ConfigurationId)(nil),                        // 50: build_event_stream.BuildEventId.ConfigurationId
	(*BuildEventId_TargetCompletedId)(nil),                      // 51: build_event_stream.BuildEventId.TargetCompletedId
	(*BuildEventId_ActionCompletedId)(nil),                      // 52: build_event_stream.BuildEventId.ActionCompletedId
	(*BuildEventId_UnconfiguredLabelId)(nil),                    // 53: build_event_stream.BuildEventId.UnconfiguredLabelId
	(*BuildEventId_ConfiguredLabelId)(nil),                      // 54: build_event_stream.BuildEventId.ConfiguredLabelId
	(*BuildEventId_TestResultId)(nil),                           // 55: build_event_stream.BuildEventId.TestResultId
	(*BuildEventId_TestProgressId)(nil),                         // 56: build_event_stream.BuildEventId.TestProgressId
	(*BuildEventId_TestSummaryId)(nil),                          // 57: build_event_stream.BuildEventId.TestSummaryId
	(*BuildEventId_TargetSummaryId)(nil),                        // 58: build_event_stream.BuildEventId.TargetSummaryId
	(*BuildEventId_BuildFinishedId)(nil),                        // 59: build_event_stream.BuildEventId.BuildFinishedId
	(*BuildEventId_BuildToolLogsId)(nil),                        // 60: build_event_stream.BuildEventId.BuildToolLogsId
	(*BuildEventId_BuildMetricsId)(nil),                         // 61: build_event_stream.BuildEventId.BuildMetricsId
	(*BuildEventId_ConvenienceSymlinksIdentifiedId)(nil),        // 62: build_event_stream.BuildEventId.ConvenienceSymlinksIdentifiedId
	(*BuildEventId_ExecRequestId)(nil),                          // 63: build_event_stream.BuildEventId.ExecRequestId
	(*WorkspaceStatus_Item)(nil),                                // 64: build_event_stream.WorkspaceStatus.Item
	nil,                                                         // 65: build_event_stream.BuildMetadata.MetadataEntry
	nil,                                                         // 66: build_event_stream.Configuration.MakeVariableEntry
	(*PatternExpanded_TestSuiteExpansion)(nil),                  // 67: build_event_stream.PatternExpanded.TestSuiteExpansion
	(*TestResult_ExecutionInfo)(nil),                            // 68: build_event_stream.TestResult.ExecutionInfo
	(*TestResult_ExecutionInfo_TimingBreakdown)(nil),            // 69: build_event_stream.TestResult.ExecutionInfo.TimingBreakdown
	(*TestResult_ExecutionInfo_ResourceUsage)(nil),              // 70: build_event_stream.TestResult.ExecutionInfo.ResourceUsage
	(*BuildFinished_ExitCode)(nil),                              // 71: build_event_stream.BuildFinished.ExitCode
	(*BuildFinished_AnomalyReport)(nil),                         // 72: build_event_stream.BuildFinished.AnomalyReport
	(*BuildMetrics_ActionSummary)(nil),                          // 73: build_event_stream.BuildMetrics.ActionSummary
	(*BuildMetrics_MemoryMetrics)(nil),                          // 74: build_event_stream.BuildMetrics.MemoryMetrics
	(*BuildMetrics_TargetMetrics)(nil),                          // 75: build_event_stream.BuildMetrics.TargetMetrics
	(*BuildMetrics_PackageMetrics)(nil),                         // 76: build_event_stream.BuildMetrics.PackageMetrics
	(*BuildMetrics_TimingMetrics)(nil),                          // 77: build_event_stream.BuildMetrics.TimingMetrics
	(*BuildMetrics_CumulativeMetrics)(nil),                      // 78: build_event_stream.BuildMetrics.CumulativeMetrics
	(*BuildMetrics_ArtifactMetrics)(nil),                        // 79: build_event_stream.BuildMetrics.ArtifactMetrics
	(*BuildMetrics_EvaluationStat)(nil),                         // 80: build_event_stream.BuildMetrics.EvaluationStat
	(*BuildMetrics_BuildGraphMetrics)(nil),                      // 81: build_event_stream.BuildMetrics.BuildGraphMetrics
	(*BuildMetrics_WorkerMetrics)(nil),                          // 82: build_event_stream.BuildMetrics.WorkerMetrics
	(*BuildMetrics_NetworkMetrics)(nil),                         // 83: build_event_stream.BuildMetrics.NetworkMetrics
	(*BuildMetrics_WorkerPoolMetrics)(nil),                      // 84: build_event_stream.BuildMetrics.WorkerPoolMetrics
	(*BuildMetrics_DynamicExecutionMetrics)(nil),                // 85: build_event_stream.BuildMetrics.DynamicExecutionMetrics
	(*BuildMetrics_Distribution)(nil),                           // 86: build_event_stream.BuildMetrics.Distribution
	(*BuildMetrics_RemoteAnalysisCacheStatistics)(nil),          // 87: build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics
	(*BuildMetrics_ActionSummary_ActionData)(nil),               // 88: build_event_stream.BuildMetrics.ActionSummary.ActionData
	(*BuildMetrics_ActionSummary_RunnerCount)(nil),              // 89: build_event_stream.BuildMetrics.ActionSummary.RunnerCount
	(*BuildMetrics_MemoryMetrics_GarbageMetrics)(nil),           // 90: build_event_stream.BuildMetrics.MemoryMetrics.GarbageMetrics
	(*BuildMetrics_ArtifactMetrics_FilesMetric)(nil),            // 91: build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	(*BuildMetrics_BuildGraphMetrics_RuleClassCount)(nil),       // 92: build_event_stream.BuildMetrics.BuildGraphMetrics.RuleClassCount
	(*BuildMetrics_BuildGraphMetrics_AspectCount)(nil),          // 93: build_event_stream.BuildMetrics.BuildGraphMetrics.AspectCount
	(*BuildMetrics_WorkerMetrics_WorkerStats)(nil),              // 94: build_event_stream.BuildMetrics.WorkerMetrics.WorkerStats
	(*BuildMetrics_NetworkMetrics_SystemNetworkStats)(nil),      // 95: build_event_stream.BuildMetrics.NetworkMetrics.SystemNetworkStats
	(*BuildMetrics_WorkerPoolMetrics_WorkerPoolStats)(nil),      // 96: build_event_stream.BuildMetrics.WorkerPoolMetrics.WorkerPoolStats
	(*BuildMetrics_DynamicExecutionMetrics_RaceStatistics)(nil), // 97: build_event_stream.BuildMetrics.DynamicExecutionMetrics.RaceStatistics
	(*BuildMetrics_Distribution_HistogramBucket)(nil),           // 98: build_event_stream.BuildMetrics.Distribution.HistogramBucket
	(*timestamppb.Timestamp)(nil),                               // 99: google.protobuf.Timestamp
	(*invocationpolicy.InvocationPolicy)(nil),                   // 100: blaze.invocation_policy.InvocationPolicy
	(*failuredetails.FailureDetail)(nil),                        // 101: failure_details.FailureDetail
	(*anypb.Any)(nil),                                           // 102: google.protobuf.Any
	(*durationpb.Duration)(nil),                                 // 103: google.protobuf.Duration
	(*commandline.CommandLine)(nil),                             // 104: command_line.CommandLine
	(*actioncache.ActionCacheStatistics)(nil),                   // 105: blaze.ActionCacheStatistics
	(*packagemetrics.PackageLoadMetrics)(nil),                   // 106: devtools.build.lib.packages.metrics.PackageLoadMetrics
	(failuredetails.Worker_Code)(0),                             // 107: failure_details.Worker.Code
	(analysiscache.TopLevelTargetsMatchStatus)(0),               // 108: devtools_blaze_proto.TopLevelTargetsMatchStatus
}
var file_build_event_stream_proto_depIdxs = []int32{
	37,  // 0: build_event_stream.BuildEventId.unknown:type_name -> build_event_stream.BuildEventId.UnknownBuildEventId
	38,  // 1: build_event_stream.BuildEventId.progress:type_name -> build_event_stream.BuildEventId.ProgressId
	39,  // 2: build_event_stream.BuildEventId.started:type_name -> build_event_stream.BuildEventId.BuildStartedId
	40,  // 3: build_event_stream.BuildEventId.unstructured_command_line:type_name -> build_event_stream.BuildEventId.UnstructuredCommandLineId
	41,  // 4: build_event_stream.BuildEventId.structured_command_line:type_name -> build_event_stream.BuildEventId.StructuredCommandLineId
	42,  // 5: build_event_stream.BuildEventId.workspace_status:type_name -> build_event_stream.BuildEventId.WorkspaceStatusId
	43,  // 6: build_event_stream.BuildEventId.options_parsed:type_name -> build_event_stream.BuildEventId.OptionsParsedId
	44,  // 7: build_event_stream.BuildEventId.fetch:type_name -> build_event_stream.BuildEventId.FetchId
	50,  // 8: build_event_stream.BuildEventId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	48,  // 9: build_event_stream.BuildEventId.target_configured:type_name -> build_event_stream.BuildEventId.TargetConfiguredId
	45,  // 10: build_event_stream.BuildEventId.pattern:type_name -> build_event_stream.BuildEventId.PatternExpandedId
	45,  // 11: build_event_stream.BuildEventId.pattern_skipped:type_name -> build_event_stream.BuildEventId.PatternExpandedId
	49,  // 12: build_event_stream.BuildEventId.named_set:type_name -> build_event_stream.BuildEventId.NamedSetOfFilesId
	51,  // 13: build_event_stream.BuildEventId.target_completed:type_name -> build_event_stream.BuildEventId.TargetCompletedId
	52,  // 14: build_event_stream.BuildEventId.action_completed:type_name -> build_event_stream.BuildEventId.ActionCompletedId
	53,  // 15: build_event_stream.BuildEventId.unconfigured_label:type_name -> build_event_stream.BuildEventId.UnconfiguredLabelId
	54,  // 16: build_event_stream.BuildEventId.configured_label:type_name -> build_event_stream.BuildEventId.ConfiguredLabelId
	55,  // 17: build_event_stream.BuildEventId.test_result:type_name -> build_event_stream.BuildEventId.TestResultId
	56,  // 18: build_event_stream.BuildEventId.test_progress:type_name -> build_event_stream.BuildEventId.TestProgressId
	57,  // 19: build_event_stream.BuildEventId.test_summary:type_name -> build_event_stream.BuildEventId.TestSummaryId
	58,  // 20: build_event_stream.BuildEventId.target_summary:type_name -> build_event_stream.BuildEventId.TargetSummaryId
	59,  // 21: build_event_stream.BuildEventId.build_finished:type_name -> build_event_stream.BuildEventId.BuildFinishedId
	60,  // 22: build_event_stream.BuildEventId.build_tool_logs:type_name -> build_event_stream.BuildEventId.BuildToolLogsId
	61,  // 23: build_event_stream.BuildEventId.build_metrics:type_name -> build_event_stream.BuildEventId.BuildMetricsId
	46,  // 24: build_event_stream.BuildEventId.workspace:type_name -> build_event_stream.BuildEventId.WorkspaceConfigId
	47,  // 25: build_event_stream.BuildEventId.build_metadata:type_name -> build_event_stream.BuildEventId.BuildMetadataId
	62,  // 26: build_event_stream.BuildEventId.convenience_symlinks_identified:type_name -> build_event_stream.BuildEventId.ConvenienceSymlinksIdentifiedId
	63,  // 27: build_event_stream.BuildEventId.exec_request:type_name -> build_event_stream.BuildEventId.ExecRequestId
	3,   // 28: build_event_stream.Aborted.reason:type_name -> build_event_stream.Aborted.AbortReason
	99,  // 29: build_event_stream.BuildStarted.start_time:type_name -> google.protobuf.Timestamp
	35,  // 30: build_event_stream.BuildStarted.java_version_info:type_name -> build_event_stream.JavaVersionInfo
	100, // 31: build_event_stream.OptionsParsed.invocation_policy:type_name -> blaze.invocation_policy.InvocationPolicy
	64,  // 32: build_event_stream.WorkspaceStatus.item:type_name -> build_event_stream.WorkspaceStatus.Item
	65,  // 33: build_event_stream.BuildMetadata.metadata:type_name -> build_event_stream.BuildMetadata.MetadataEntry
	66,  // 34: build_event_stream.Configuration.make_variable:type_name -> build_event_stream.Configuration.MakeVariableEntry
	67,  // 35: build_event_stream.PatternExpanded.test_suite_expansions:type_name -> build_event_stream.PatternExpanded.TestSuiteExpansion
	0,   // 36: build_event_stream.TargetConfigured.test_size:type_name -> build_event_stream.TestSize
	19,  // 37: build_event_stream.NamedSetOfFiles.files:type_name -> build_event_stream.File
	49,  // 38: build_event_stream.NamedSetOfFiles.file_sets:type_name -> build_event_stream.BuildEventId.NamedSetOfFilesId
	19,  // 39: build_event_stream.ActionExecuted.stdout:type_name -> build_event_stream.File
	19,  // 40: build_event_stream.ActionExecuted.stderr:type_name -> build_event_stream.File
	50,  // 41: build_event_stream.ActionExecuted.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	19,  // 42: build_event_stream.ActionExecuted.primary_output:type_name -> build_event_stream.File
	101, // 43: build_event_stream.ActionExecuted.failure_detail:type_name -> failure_details.FailureDetail
	99,  // 44: build_event_stream.ActionExecuted.start_time:type_name -> google.protobuf.Timestamp
	99,  // 45: build_event_stream.ActionExecuted.end_time:type_name -> google.protobuf.Timestamp
	102, // 46: build_event_stream.ActionExecuted.strategy_details:type_name -> google.protobuf.Any
	49,  // 47: build_event_stream.OutputGroup.file_sets:type_name -> build_event_stream.BuildEventId.NamedSetOfFilesId
	19,  // 48: build_event_stream.OutputGroup.inline_files:type_name -> build_event_stream.File
	0,   // 49: build_event_stream.TargetComplete.test_size:type_name -> build_event_stream.TestSize
	22,  // 50: build_event_stream.TargetComplete.output_group:type_name -> build_event_stream.OutputGroup
	19,  // 51: build_event_stream.TargetComplete.important_output:type_name -> build_event_stream.File
	19,  // 52: build_event_stream.TargetComplete.directory_output:type_name -> build_event_stream.File
	103, // 53: build_event_stream.TargetComplete.test_timeout:type_name -> google.protobuf.Duration
	101, // 54: build_event_stream.TargetComplete.failure_detail:type_name -> failure_details.FailureDetail
	1,   // 55: build_event_stream.TestResult.status:type_name -> build_event_stream.TestStatus
	99,  // 56: build_event_stream.TestResult.test_attempt_start:type_name -> google.protobuf.Timestamp
	103, // 57: build_event_stream.TestResult.test_attempt_duration:type_name -> google.protobuf.Duration
	19,  // 58: build_event_stream.TestResult.test_action_output:type_name -> build_event_stream.File
	68,  // 59: build_event_stream.TestResult.execution_info:type_name -> build_event_stream.TestResult.ExecutionInfo
	1,   // 60: build_event_stream.TestSummary.overall_status:type_name -> build_event_stream.TestStatus
	19,  // 61: build_event_stream.TestSummary.passed:type_name -> build_event_stream.File
	19,  // 62: build_event_stream.TestSummary.failed:type_name -> build_event_stream.File
	99,  // 63: build_event_stream.TestSummary.first_start_time:type_name -> google.protobuf.Timestamp
	99,  // 64: build_event_stream.TestSummary.last_stop_time:type_name -> google.protobuf.Timestamp
	103, // 65: build_event_stream.TestSummary.total_run_duration:type_name -> google.protobuf.Duration
	1,   // 66: build_event_stream.TargetSummary.overall_test_status:type_name -> build_event_stream.TestStatus
	71,  // 67: build_event_stream.BuildFinished.exit_code:type_name -> build_event_stream.BuildFinished.ExitCode
	99,  // 68: build_event_stream.BuildFinished.finish_time:type_name -> google.protobuf.Timestamp
	72,  // 69: build_event_stream.BuildFinished.anomaly_report:type_name -> build_event_stream.BuildFinished.AnomalyReport
	101, // 70: build_event_stream.BuildFinished.failure_detail:type_name -> failure_details.FailureDetail
	73,  // 71: build_event_stream.BuildMetrics.action_summary:type_name -> build_event_stream.BuildMetrics.ActionSummary
	74,  // 72: build_event_stream.BuildMetrics.memory_metrics:type_name -> build_event_stream.BuildMetrics.MemoryMetrics
	75,  // 73: build_event_stream.BuildMetrics.target_metrics:type_name -> build_event_stream.BuildMetrics.TargetMetrics
	76,  // 74: build_event_stream.BuildMetrics.package_metrics:type_name -> build_event_stream.BuildMetrics.PackageMetrics
	77,  // 75: build_event_stream.BuildMetrics.timing_metrics:type_name -> build_event_stream.BuildMetrics.TimingMetrics
	78,  // 76: build_event_stream.BuildMetrics.cumulative_metrics:type_name -> build_event_stream.BuildMetrics.CumulativeMetrics
	79,  // 77: build_event_stream.BuildMetrics.artifact_metrics:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics
	81,  // 78: build_event_stream.BuildMetrics.build_graph_metrics:type_name -> build_event_stream.BuildMetrics.BuildGraphMetrics
	82,  // 79: build_event_stream.BuildMetrics.worker_metrics:type_name -> build_event_stream.BuildMetrics.WorkerMetrics
	83,  // 80: build_event_stream.BuildMetrics.network_metrics:type_name -> build_event_stream.BuildMetrics.NetworkMetrics
	84,  // 81: build_event_stream.BuildMetrics.worker_pool_metrics:type_name -> build_event_stream.BuildMetrics.WorkerPoolMetrics
	85,  // 82: build_event_stream.BuildMetrics.dynamic_execution_metrics:type_name -> build_event_stream.BuildMetrics.DynamicExecutionMetrics
	87,  // 83: build_event_stream.BuildMetrics.remote_analysis_cache_statistics:type_name -> build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics
	19,  // 84: build_event_stream.BuildToolLogs.log:type_name -> build_event_stream.File
	32,  // 85: build_event_stream.ConvenienceSymlinksIdentified.convenience_symlinks:type_name -> build_event_stream.ConvenienceSymlink
	5,   // 86: build_event_stream.ConvenienceSymlink.action:type_name -> build_event_stream.ConvenienceSymlink.Action
	34,  // 87: build_event_stream.ExecRequestConstructed.environment_variable:type_name -> build_event_stream.EnvironmentVariable
	6,   // 88: build_event_stream.BuildEvent.id:type_name -> build_event_stream.BuildEventId
	6,   // 89: build_event_stream.BuildEvent.children:type_name -> build_event_stream.BuildEventId
	7,   // 90: build_event_stream.BuildEvent.progress:type_name -> build_event_stream.Progress
	8,   // 91: build_event_stream.BuildEvent.aborted:type_name -> build_event_stream.Aborted
	9,   // 92: build_event_stream.BuildEvent.started:type_name -> build_event_stream.BuildStarted
	11,  // 93: build_event_stream.BuildEvent.unstructured_command_line:type_name -> build_event_stream.UnstructuredCommandLine
	104, // 94: build_event_stream.BuildEvent.structured_command_line:type_name -> command_line.CommandLine
	12,  // 95: build_event_stream.BuildEvent.options_parsed:type_name -> build_event_stream.OptionsParsed
	14,  // 96: build_event_stream.BuildEvent.workspace_status:type_name -> build_event_stream.WorkspaceStatus
	13,  // 97: build_event_stream.BuildEvent.fetch:type_name -> build_event_stream.Fetch
	16,  // 98: build_event_stream.BuildEvent.configuration:type_name -> build_event_stream.Configuration
	17,  // 99: build_event_stream.BuildEvent.expanded:type_name -> build_event_stream.PatternExpanded
	18,  // 100: build_event_stream.BuildEvent.configured:type_name -> build_event_stream.TargetConfigured
	21,  // 101: build_event_stream.BuildEvent.action:type_name -> build_event_stream.ActionExecuted
	20,  // 102: build_event_stream.BuildEvent.named_set_of_files:type_name -> build_event_stream.NamedSetOfFiles
	23,  // 103: build_event_stream.BuildEvent.completed:type_name -> build_event_stream.TargetComplete
	24,  // 104: build_event_stream.BuildEvent.test_result:type_name -> build_event_stream.TestResult
	25,  // 105: build_event_stream.BuildEvent.test_progress:type_name -> build_event_stream.TestProgress
	26,  // 106: build_event_stream.BuildEvent.test_summary:type_name -> build_event_stream.TestSummary
	27,  // 107: build_event_stream.BuildEvent.target_summary:type_name -> build_event_stream.TargetSummary
	28,  // 108: build_event_stream.BuildEvent.finished:type_name -> build_event_stream.BuildFinished
	30,  // 109: build_event_stream.BuildEvent.build_tool_logs:type_name -> build_event_stream.BuildToolLogs
	29,  // 110: build_event_stream.BuildEvent.build_metrics:type_name -> build_event_stream.BuildMetrics
	10,  // 111: build_event_stream.BuildEvent.workspace_info:type_name -> build_event_stream.WorkspaceConfig
	15,  // 112: build_event_stream.BuildEvent.build_metadata:type_name -> build_event_stream.BuildMetadata
	31,  // 113: build_event_stream.BuildEvent.convenience_symlinks_identified:type_name -> build_event_stream.ConvenienceSymlinksIdentified
	33,  // 114: build_event_stream.BuildEvent.exec_request:type_name -> build_event_stream.ExecRequestConstructed
	2,   // 115: build_event_stream.BuildEventId.FetchId.downloader:type_name -> build_event_stream.BuildEventId.FetchId.Downloader
	50,  // 116: build_event_stream.BuildEventId.TargetCompletedId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	50,  // 117: build_event_stream.BuildEventId.ActionCompletedId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	50,  // 118: build_event_stream.BuildEventId.ConfiguredLabelId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	50,  // 119: build_event_stream.BuildEventId.TestResultId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	50,  // 120: build_event_stream.BuildEventId.TestProgressId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	50,  // 121: build_event_stream.BuildEventId.TestSummaryId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	50,  // 122: build_event_stream.BuildEventId.TargetSummaryId.configuration:type_name -> build_event_stream.BuildEventId.ConfigurationId
	69,  // 123: build_event_stream.TestResult.ExecutionInfo.timing_breakdown:type_name -> build_event_stream.TestResult.ExecutionInfo.TimingBreakdown
	70,  // 124: build_event_stream.TestResult.ExecutionInfo.resource_usage:type_name -> build_event_stream.TestResult.ExecutionInfo.ResourceUsage
	69,  // 125: build_event_stream.TestResult.ExecutionInfo.TimingBreakdown.child:type_name -> build_event_stream.TestResult.ExecutionInfo.TimingBreakdown
	103, // 126: build_event_stream.TestResult.ExecutionInfo.TimingBreakdown.time:type_name -> google.protobuf.Duration
	88,  // 127: build_event_stream.BuildMetrics.ActionSummary.action_data:type_name -> build_event_stream.BuildMetrics.ActionSummary.ActionData
	89,  // 128: build_event_stream.BuildMetrics.ActionSummary.runner_count:type_name -> build_event_stream.BuildMetrics.ActionSummary.RunnerCount
	105, // 129: build_event_stream.BuildMetrics.ActionSummary.action_cache_statistics:type_name -> blaze.ActionCacheStatistics
	90,  // 130: build_event_stream.BuildMetrics.MemoryMetrics.garbage_metrics:type_name -> build_event_stream.BuildMetrics.MemoryMetrics.GarbageMetrics
	106, // 131: build_event_stream.BuildMetrics.PackageMetrics.package_load_metrics:type_name -> devtools.build.lib.packages.metrics.PackageLoadMetrics
	103, // 132: build_event_stream.BuildMetrics.TimingMetrics.critical_path_time:type_name -> google.protobuf.Duration
	91,  // 133: build_event_stream.BuildMetrics.ArtifactMetrics.source_artifacts_read:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	91,  // 134: build_event_stream.BuildMetrics.ArtifactMetrics.output_artifacts_seen:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	91,  // 135: build_event_stream.BuildMetrics.ArtifactMetrics.output_artifacts_from_action_cache:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	91,  // 136: build_event_stream.BuildMetrics.ArtifactMetrics.top_level_artifacts:type_name -> build_event_stream.BuildMetrics.ArtifactMetrics.FilesMetric
	80,  // 137: build_event_stream.BuildMetrics.BuildGraphMetrics.dirtied_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	80,  // 138: build_event_stream.BuildMetrics.BuildGraphMetrics.changed_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	80,  // 139: build_event_stream.BuildMetrics.BuildGraphMetrics.built_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	80,  // 140: build_event_stream.BuildMetrics.BuildGraphMetrics.cleaned_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	80,  // 141: build_event_stream.BuildMetrics.BuildGraphMetrics.evaluated_values:type_name -> build_event_stream.BuildMetrics.EvaluationStat
	92,  // 142: build_event_stream.BuildMetrics.BuildGraphMetrics.rule_class:type_name -> build_event_stream.BuildMetrics.BuildGraphMetrics.RuleClassCount
	93,  // 143: build_event_stream.BuildMetrics.BuildGraphMetrics.aspect:type_name -> build_event_stream.BuildMetrics.BuildGraphMetrics.AspectCount
	4,   // 144: build_event_stream.BuildMetrics.WorkerMetrics.worker_status:type_name -> build_event_stream.BuildMetrics.WorkerMetrics.WorkerStatus
	107, // 145: build_event_stream.BuildMetrics.WorkerMetrics.code:type_name -> failure_details.Worker.Code
	94,  // 146: build_event_stream.BuildMetrics.WorkerMetrics.worker_stats:type_name -> build_event_stream.BuildMetrics.WorkerMetrics.WorkerStats
	95,  // 147: build_event_stream.BuildMetrics.NetworkMetrics.system_network_stats:type_name -> build_event_stream.BuildMetrics.NetworkMetrics.SystemNetworkStats
	96,  // 148: build_event_stream.BuildMetrics.WorkerPoolMetrics.worker_pool_stats:type_name -> build_event_stream.BuildMetrics.WorkerPoolMetrics.WorkerPoolStats
	97,  // 149: build_event_stream.BuildMetrics.DynamicExecutionMetrics.race_statistics:type_name -> build_event_stream.BuildMetrics.DynamicExecutionMetrics.RaceStatistics
	98,  // 150: build_event_stream.BuildMetrics.Distribution.histogram_bucket:type_name -> build_event_stream.BuildMetrics.Distribution.HistogramBucket
	86,  // 151: build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics.value_store_read_latency_micros:type_name -> build_event_stream.BuildMetrics.Distribution
	86,  // 152: build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics.value_store_read_batch_latency_micros:type_name -> build_event_stream.BuildMetrics.Distribution
	86,  // 153: build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics.value_store_write_latency_micros:type_name -> build_event_stream.BuildMetrics.Distribution
	86,  // 154: build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics.value_store_write_batch_latency_micros:type_name -> build_event_stream.BuildMetrics.Distribution
	86,  // 155: build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics.analysis_cache_read_latency_micros:type_name -> build_event_stream.BuildMetrics.Distribution
	86,  // 156: build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics.analysis_cache_read_batch_latency_micros:type_name -> build_event_stream.BuildMetrics.Distribution
	108, // 157: build_event_stream.BuildMetrics.RemoteAnalysisCacheStatistics.metadata_lookup_result:type_name -> devtools_blaze_proto.TopLevelTargetsMatchStatus
	103, // 158: build_event_stream.BuildMetrics.ActionSummary.ActionData.system_time:type_name -> google.protobuf.Duration
	103, // 159: build_event_stream.BuildMetrics.ActionSummary.ActionData.user_time:type_name -> google.protobuf.Duration
...
func file_build_event_stream_proto_init() {
	...
	file_build_event_stream_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_build_event_stream_proto_msgTypes[13].OneofWrappers = []any{
		(*File_Uri)(nil),
		(*File_Contents)(nil),
		(*File_SymlinkTargetPath)(nil),
	}
	file_build_event_stream_proto_msgTypes[30].OneofWrappers = []any{
	...
	file_build_event_stream_proto_msgTypes[76].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_build_event_stream_proto_rawDesc), len(file_build_event_stream_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   93,
			NumExtensions: 0,
			NumServices:   0,
