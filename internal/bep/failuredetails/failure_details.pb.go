...
func (Crash_OomCauseCategory) EnumDescriptor() ([]byte, []int) {
	return file_failure_details_proto_rawDescGZIP(), []int{8, 1}
}
...
const (
	...
	RemoteAnalysisCaching_CANNOT_OPEN_LOG_FILE               RemoteAnalysisCaching_Code = 5
)
...
const (
	...
	Filesystem_REMOTE_FILE_EVICTED                        Filesystem_Code = 13
)
...
const (
	...
	//
	// Deprecated: Marked as deprecated in failure_details.proto.
...
const (
	...
	CppCompile_MODMAP_INPUT_FILE_READ_FAILURE  CppCompile_Code = 12
)
...
var (
	CppCompile_Code_name = map[int32]string{
		...
		12: "MODMAP_INPUT_FILE_READ_FAILURE",
	}
	CppCompile_Code_value = map[string]int32{
		...
		"MODMAP_INPUT_FILE_READ_FAILURE":  12,
	}
)
...
func (StarlarkLoading_Code) Descriptor() protoreflect.EnumDescriptor {
	return file_failure_details_proto_enumTypes[61].Descriptor()
}

func (StarlarkLoading_Code) Type() protoreflect.EnumType {
	return &file_failure_details_proto_enumTypes[61]
}
...
func (ExternalDeps_Code) Descriptor() protoreflect.EnumDescriptor {
	return file_failure_details_proto_enumTypes[62].Descriptor()
}

func (ExternalDeps_Code) Type() protoreflect.EnumType {
	return &file_failure_details_proto_enumTypes[62]
}
...
func (ExternalDeps_Code) EnumDescriptor() ([]byte, []int) {
	return file_failure_details_proto_rawDescGZIP(), []int{64, 0}
}
...
func (DiffAwareness_Code) Descriptor() protoreflect.EnumDescriptor {
	return file_failure_details_proto_enumTypes[63].Descriptor()
}

func (DiffAwareness_Code) Type() protoreflect.EnumType {
	return &file_failure_details_proto_enumTypes[63]
}
...
func (DiffAwareness_Code) EnumDescriptor() ([]byte, []int) {
	return file_failure_details_proto_rawDescGZIP(), []int{65, 0}
}
...
func (ModCommand_Code) Descriptor() protoreflect.EnumDescriptor {
	return file_failure_details_proto_enumTypes[64].Descriptor()
}

func (ModCommand_Code) Type() protoreflect.EnumType {
	return &file_failure_details_proto_enumTypes[64]
}
...
func (ModCommand_Code) EnumDescriptor() ([]byte, []int) {
	return file_failure_details_proto_rawDescGZIP(), []int{66, 0}
}
...
func (x *ExternalDeps) Reset() {
	*x = ExternalDeps{}
	mi := &file_failure_details_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExternalDeps) Descriptor() ([]byte, []int) {
	return file_failure_details_proto_rawDescGZIP(), []int{64}
}
...
func (x *DiffAwareness) Reset() {
	*x = DiffAwareness{}
	mi := &file_failure_details_proto_msgTypes[65]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DiffAwareness) Descriptor() ([]byte, []int) {
	return file_failure_details_proto_rawDescGZIP(), []int{65}
}
...
func (x *ModCommand) Reset() {
	*x = ModCommand{}
	mi := &file_failure_details_proto_msgTypes[66]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ModCommand) Descriptor() ([]byte, []int) {
	return file_failure_details_proto_rawDescGZIP(), []int{66}
}
...
const file_failure_details_proto_rawDesc = "" +
	"\n" +
	"\x15failure_details.proto\x12\x0ffailure_details\x1a google/protobuf/descriptor.proto\"4\n" +
	...
	"%DISALLOWED_OPERATION_ON_FOCUSED_GRAPH\x10\x03\x1a\x05\xb2C\x02\b\x02\"\xc4\x02\n" +
	"\x15RemoteAnalysisCaching\x12?\n" +
	"\x04code\x18\x01 \x01(\x0e2+.failure_details.RemoteAnalysisCaching.CodeR\x04code\"\xe9\x01\n" +
	"\x04Code\x12*\n" +
	...
	"\x16INVALID_SERVER_ADDRESS\x10\x04\x1a\x05\xb2C\x02\b\x02\x12\x1f\n" +
	"\x14CANNOT_OPEN_LOG_FILE\x10\x05\x1a\x05\xb2C\x02\b$\"\xc9\x01\n" +
	...
	"\x04Code\x12 \n" +
	"\x15CRASH_OPTIONS_UNKNOWN\x10\x00\x1a\x05\xb2C\x02\b%\"\x04\b\x01\x10\x01\"\xb5\x03\n" +
	"\n" +
	"Filesystem\x124\n" +
	"\x04code\x18\x01 \x01(\x0e2 .failure_details.Filesystem.CodeR\x04code\"\xf0\x02\n" +
	"\x04Code\x12\x1d\n" +
	...
	"\x1bFAILED_TO_LOCK_INSTALL_BASE\x10\f\x1a\x05\xb2C\x02\b$\x12\x1e\n" +
	"\x13REMOTE_FILE_EVICTED\x10\r\x1a\x05\xb2C\x02\b'\"\x04\b\x01\x10\x01\"\x04\b\x02\x10\x02\"\x04\b\a\x10\a\"\x04\b\t\x10\t\"\x04\b\n" +
	"\x10\n" +
	"\"\xa7\x04\n" +
	...
	"\x1fDEPRECATED_LOST_INPUT_IS_SOURCE\x10\x02\x1a\a\xb2C\x02\b\x01\b\x01\"\xbe\x04\n" +
	"\n" +
	"CppCompile\x124\n" +
	"\x04code\x18\x01 \x01(\x0e2 .failure_details.CppCompile.CodeR\x04code\"\xf9\x03\n" +
	"\x04Code\x12\x1e\n" +
	...
	"\x1a\x05\xb2C\x02\b\x01\x12(\n" +
	"\x1dMODULE_EXPANSION_MISSING_DATA\x10\v\x1a\x05\xb2C\x02\b\x01\x12)\n" +
	"\x1eMODMAP_INPUT_FILE_READ_FAILURE\x10\f\x1a\x05\xb2C\x02\b$\"\xcf\x01\n" +
	...
	"\bmetadata\x12!.google.protobuf.EnumValueOptions\x18\xb6\b \x01(\v2&.failure_details.FailureDetailMetadataR\bmetadataB;Z9github.com/chagui/besreceiver/internal/bep/failuredetailsb\x06proto3"

var (
	file_failure_details_proto_rawDescOnce sync.Once
	file_failure_details_proto_rawDescData []byte
)

func file_failure_details_proto_rawDescGZIP() []byte {
	file_failure_details_proto_rawDescOnce.Do(func() {
		file_failure_details_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_failure_details_proto_rawDesc), len(file_failure_details_proto_rawDesc)))
	})
	return file_failure_details_proto_rawDescData
}

var file_failure_details_proto_enumTypes = make([]protoimpl.EnumInfo, 65)
var file_failure_details_proto_msgTypes = make([]protoimpl.MessageInfo, 67)
var file_failure_details_proto_goTypes = []any{
...
func file_failure_details_proto_init() {
	...
	file_failure_details_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_failure_details_proto_rawDesc), len(file_failure_details_proto_rawDesc)),
			NumEnums:      65,
			NumMessages:   67,
			NumExtensions: 1,
			NumServices:   0,
