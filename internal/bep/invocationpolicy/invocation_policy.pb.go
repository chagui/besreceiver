...
import (
	strategypolicy "github.com/chagui/besreceiver/internal/bep/strategypolicy"
...
const file_invocation_policy_proto_rawDesc = "" +
	"\n" +
	"\x17invocation_policy.proto\x12\x17blaze.invocation_policy\x1a\x15strategy_policy.proto\"\xac\x01\n" +
	...
	"\vuse_default\x18\x04 \x01(\v2#.blaze.invocation_policy.UseDefaultH\x00R\n" +
	"useDefaultB\x13\n" +
	"\x11replacement_valueJ\x04\b\x02\x10\x03B=Z;github.com/chagui/besreceiver/internal/bep/invocationpolicy"

var (
	file_invocation_policy_proto_rawDescOnce sync.Once
	file_invocation_policy_proto_rawDescData []byte
)

func file_invocation_policy_proto_rawDescGZIP() []byte {
	file_invocation_policy_proto_rawDescOnce.Do(func() {
		file_invocation_policy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_invocation_policy_proto_rawDesc), len(file_invocation_policy_proto_rawDesc)))
	})
...
var file_invocation_policy_proto_goTypes = []any{
...
func file_invocation_policy_proto_init() {
	...
	file_invocation_policy_proto_msgTypes[1].OneofWrappers = []any{
		(*FlagPolicy_SetValue)(nil),
		(*FlagPolicy_UseDefault)(nil),
		(*FlagPolicy_DisallowValues)(nil),
		(*FlagPolicy_AllowValues)(nil),
	}
	file_invocation_policy_proto_msgTypes[4].OneofWrappers = []any{
		(*DisallowValues_NewValue)(nil),
		(*DisallowValues_UseDefault)(nil),
	}
	file_invocation_policy_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_invocation_policy_proto_rawDesc), len(file_invocation_policy_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
