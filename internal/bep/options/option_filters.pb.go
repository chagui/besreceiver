...
const (
	...
	OptionMetadataTag_NON_CONFIGURABLE    OptionMetadataTag = 8
)
...
const file_option_filters_proto_rawDesc = "" +
	"\n" +
	"\x14option_filters.proto\x12\aoptions*\xea\x02\n" +
	...
	"\bINTERNAL\x10\x04\x12\x14\n" +
	"\x10NON_CONFIGURABLE\x10\b\"\x04\b\x05\x10\x05\"\x04\b\x06\x10\x06\"\x04\b\a\x10\a*%TRIGGERED_BY_ALL_INCOMPATIBLE_CHANGES*\x17EXPLICIT_IN_OUTPUT_PATH*\tIMMUTABLEB4Z2github.com/chagui/besreceiver/internal/bep/optionsb\x06proto3"

var (
	file_option_filters_proto_rawDescOnce sync.Once
	file_option_filters_proto_rawDescData []byte
)

func file_option_filters_proto_rawDescGZIP() []byte {
	file_option_filters_proto_rawDescOnce.Do(func() {
		file_option_filters_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_option_filters_proto_rawDesc), len(file_option_filters_proto_rawDesc)))
	})
	return file_option_filters_proto_rawDescData
}

var file_option_filters_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_option_filters_proto_goTypes = []any{
...
func file_option_filters_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_option_filters_proto_rawDesc), len(file_option_filters_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
