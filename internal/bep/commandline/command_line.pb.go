...
import (
	options "github.com/chagui/besreceiver/internal/bep/options"
...
const file_command_line_proto_rawDesc = "" +
	"\n" +
	"\x12command_line.proto\x12\fcommand_line\x1a\x14option_filters.proto\"y\n" +
	"\vCommandLine\x12,\n" +
	...
	"\x06source\x18\x06 \x01(\tR\x06sourceB8Z6github.com/chagui/besreceiver/internal/bep/commandlineb\x06proto3"

var (
	file_command_line_proto_rawDescOnce sync.Once
	file_command_line_proto_rawDescData []byte
)

func file_command_line_proto_rawDescGZIP() []byte {
	file_command_line_proto_rawDescOnce.Do(func() {
		file_command_line_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_command_line_proto_rawDesc), len(file_command_line_proto_rawDesc)))
	})
	return file_command_line_proto_rawDescData
}

var file_command_line_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_command_line_proto_goTypes = []any{
...
func file_command_line_proto_init() {
	...
	file_command_line_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_command_line_proto_rawDesc), len(file_command_line_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
